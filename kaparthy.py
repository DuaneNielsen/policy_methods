...
while True:
    ...
    if done:  # an episode finished
        ...
        tb.add_scalar('reward', reward_sum, tb_step)
        tb.add_scalar('ave_game_len', statistics.mean(ave_game_len), tb_step)
        tb.add_scalar('max_game_len', max(ave_game_len), tb_step)
        ave_game_len = []
        reward_sum = 0
        tb_step += 1
